...
describe('Config', function () {
    ...
    describe('#function loadConfiguration', function () {
        ...
        alert = function (message) {
            mockAlertMessage = message;
        };

        it('should load configuration on format 1.0  ', function () {
            const config =
                '{"format_version":"1.0","target_page":"https://httpbin.org/*","headers":[{"action":"add","header_name":"test-header-name","header_value":"test-header-value","comment":"test","status":"on"}]}';
        ...
        it('should load configuration on format 1.1  ', function () {
            const config =
                '{"format_version":"1.1","target_page":"https://httpbin.org/*","headers":[{"action":"add","header_name":"test-header-name","header_value":"test-header-value","comment":"test","apply_on":"res","status":"on"}]}';
        ...
        it('should load configuration on modify header format  ', function () {
            const config =
                '[{"action":"Add","name":"test-header-name","value":"test-header-value","comment":"test","enabled":"true"},{"action":"Add","name":"test-header-name2","value":"test-header-value2","comment":"test","enabled":"true"}]';
        ...
        it('should popup an alert if json is invalid ', function () {
            const config =
                '{"formaversion":"1.2","target_pae":"https://httpbin.org/*","debu_mode":true,"header":[{"url_contains":"test","action":"add","header_name":"test-header-name","headevalue":"test-header-value","comment":"test","apply_on":"res","status":"on"}]}';
            mockAlertMessage = '';
            loadConfiguration(config);
